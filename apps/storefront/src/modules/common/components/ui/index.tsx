  ...
  (
    ...
    return (
      <button
        ...
        className={clsx(
          "inline-flex gap-2 items-center justify-center rounded-none font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-kv-accent focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
          variant === "primary" && "bg-kv-primary text-kv-bg hover:opacity-85 uppercase text-[13px] tracking-kv-wider font-semibold",
          variant === "secondary" &&
            "bg-transparent text-kv-primary border border-kv-border hover:border-kv-primary uppercase text-[13px] tracking-kv-wider font-medium",
          variant === "transparent" && "bg-transparent hover:bg-kv-surface text-kv-primary",
...
export const Container = forwardRef<HTMLDivElement, ContainerProps>(
  ({ className, children, ...props }, ref) => {
    return (
      <div
        ref={ref}
        className={clsx("bg-kv-bg p-4", className)}
        {...props}
      >
        {children}
      </div>
    ...
    return (
      <div className="flex flex-col gap-1">
        ...
        <input
          ref={ref}
          className={clsx(
            "flex h-10 w-full rounded-none border border-kv-border bg-kv-bg px-3 py-2 text-sm text-kv-primary placeholder:text-kv-secondary focus:outline-none focus:ring-2 focus:ring-kv-accent focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50",
            className
          )}
          {...props}
        />
  ...
  ({ className, children, ...props }, ref) => {
    return (
      <tr
        ref={ref}
        className={clsx(
          "border-b border-kv-border transition-colors hover:bg-kv-surface",
          className
        )}
        {...props}
      >
